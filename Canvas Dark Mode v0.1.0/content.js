//This targets class display boxes with the background images in them and removes them.
function removeClassBoxBackgroundImages() {
	var classDisplayBoxes = document.getElementsByClassName("Grouping-styles__hero Grouping-styles__heroHover");
	for (var i = 0; i < classDisplayBoxes.length; i++) {
		classDisplayBoxes[i].style = "";
	}
}
...
setInterval(removeClassBoxBackgroundImages, updateTime);
